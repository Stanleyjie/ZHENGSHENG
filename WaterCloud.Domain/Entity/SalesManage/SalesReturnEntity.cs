...
namespace WaterCloud.Domain.SalesManage
{
    ...
    /// 描 述：销售退货单实体类
    /// </summary>
    [TableAttribute("mes_SalesReturn")]
    public class SalesReturnEntity : IEntity<SalesReturnEntity>, ICreationAudited, IModificationAudited, IDeleteAudited
    {
        ...
        [NotMapped]
        public List<SalesReturnDetailEntity> list { get; set; }
    }
}
