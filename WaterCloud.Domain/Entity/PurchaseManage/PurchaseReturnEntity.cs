...
namespace WaterCloud.Domain.PurchaseManage
{
    ...
    /// 描 述：采购退货单实体类
    /// </summary>
    [TableAttribute("mes_PurchaseReturn")]
    public class PurchaseReturnEntity : IEntity<PurchaseReturnEntity>, ICreationAudited, IModificationAudited, IDeleteAudited
    {
        ...
        /// 退货单编号
        /// </summary>
        public string F_ReturnCode { get; set; }
        /// <summary>
        /// 关联采购订单Id
        /// </summary>
        ...
        [NotMapped]
        public List<PurchaseReturnDetailEntity> list { get; set; }
    }
}
