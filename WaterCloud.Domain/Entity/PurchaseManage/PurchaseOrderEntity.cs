...
namespace WaterCloud.Domain.PurchaseManage
{
    ...
    public class PurchaseOrderEntity : IEntity<PurchaseOrderEntity>, ICreationAudited, IModificationAudited, IDeleteAudited
    {
        /// <summary>
        /// id
        /// </summary>
        ...
        /// </summary>
        [NotMapped]
        public List<PurchaseOrderDetailEntity> list { get; set; }
        /// <summary>
        /// 是否结案
        /// </summary>
