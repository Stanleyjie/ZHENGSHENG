...
namespace WaterCloud.Web.Areas.SalesManage.Controllers
{
    ...
    {
        public SalesDeliveryService _service { get; set; }
        #region 获取数据
        [HandlerAjaxOnly]
        [IgnoreAntiforgeryToken]
        public async Task<ActionResult> GetGridJson(SoulPage<SalesDeliveryEntity> pagination, string keyword)
        {
        ...
        [HttpPost]
        [HandlerAjaxOnly]
        public async Task<ActionResult> SubmitForm(SalesDeliveryEntity entity, string keyValue)
        {
            try
            {
